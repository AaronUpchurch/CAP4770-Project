...
"""
List of country pages that are broken:
    Austria
    Benin
...
directory = os.fsencode("C:/Users/TheNicMachine/Desktop/Country Datas/factbook-2015/geos")

urls = []
for filename in os.listdir(directory):
    f = os.fsdecode(filename)
    if f.endswith(".html") and "countrytemplate" not in f and "print_" not in f:
        urls.append("C:/Users/TheNicMachine/Desktop/Country Datas/factbook-2015/geos/" + f)
...
for url in urls:
    ...
    broken_pages = ["../geos/au.html", "../geos/bn.html", "../geos/cg.html", "../geos/ee.html", "../geos/fq.html", "../geos/lh.html",
                    "../geos/lt.html", "../geos/pa.html", "../geos/sg.html", "../geos/th.html", "../geos/uk.html"
                    ]
    if code in broken_pages:
        continue

    # World Page has unique code to find country name
    if code == "../geos/xx.html":
        country_name = soup.find_all('div', {"class": "region_name1"})[0].get_text()
    ...
    file_name = code[8:10]
    file_path = 'C:/Users/TheNicMachine/Desktop/Country Datas/countries2015/' + file_name + '.json' 
