...
directory = os.fsencode("C:/Users/TheNicMachine/Desktop/Country Datas/factbook-2011/geos")

urls = []
for filename in os.listdir(directory):
    f = os.fsdecode(filename)
    if f.endswith(".html") and "countrytemplate" not in f and "print_" not in f:
        urls.append("C:/Users/TheNicMachine/Desktop/Country Datas/factbook-2011/geos/" + f)
...
for url in urls:
    ...
    sections = ["Introduction", "Geography", "People and Society", "Government", "Economy", "Communications",
    ...
    file_name = code[8:10]
    file_path = 'C:/Users/TheNicMachine/Desktop/Country Datas/countries2011/' + file_name + '.json' 
